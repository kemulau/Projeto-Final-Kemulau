...
<div class="min-h-screen flex flex-col items-center justify-center bg-gray-100 px-4">
    ...
    <div class="w-full max-w-md bg-white rounded-lg shadow-md p-6 border-t-8 border-orange-700">
        <h2 class="text-2xl font-bold text-center text-orange-700 mb-6">Bem-vindo de volta!</h2>
        ...
        <form wire:submit="login" class="space-y-4">
            ...
            <div class="flex items-center">
                ...
                <label for="remember" class="ml-2 text-sm text-gray-700">Lembrar neste navegador</label>
            </div>
            ...
            <div class="flex items-center justify-between">
                @if (Route::has('password.request'))
                    <a href="{{ route('password.request') }}" wire:navigate
                       class="text-sm text-gray-600 hover:text-orange-700 underline">
