<nav class="navbar bg-orange-800 text-white px-4 py-2">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center justify-between">
        ...
        <div id="mobileNav"
            ...
            <a href="{{ route('catalogo') }}"><i class="fas fa-store"></i> Catálogo</a>
            <a href="{{ route('carrinho.index') }}"><i class="fas fa-shopping-cart"></i> Carrinho</a>
            <a href="{{ route('compras.index') }}"><i class="fas fa-file-invoice-dollar"></i> Compras</a>
